...
Huom! ShanG on kasviryhmien monimuotoisuutta kuvaava indeksi. Ei yksittäisten kasviluokitusten (shan).
...
Taulukon mukaan mallit M4 ja M2 ovat parhaimpia, 1.07 AICc yksikön erolla toisistaan. 

Tehdään model averaging M4 ja M2 malleilla:
...
Joenpientareilla näyttäisi olevan merkitsevä positiivinen vaikutus reviirien määrään. Rakennuksilla taasen ei-merkitsevä negatiivinen.
...
```
Hmm.. Tämän mukaan malli G2 ja G4 ovat parhaimpia. G2 on yksinkertaisempi.
