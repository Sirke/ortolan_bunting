...
Vuoden keskittäminen? Vuosi 2000 olisi baseline ja siitä eteenpäin vuosi 1,2,3 jne.

Voiko glmmTMB:lle olla ongelma se, ettei joiltain osapopulaatioilta ole kuin yksi havainto?
...
Skaalaus ei auta (mean zero, unit variance). Mikään malleista ei toimi edelleenkään. 
...
library("glmmADMB")
M1A=glmmadmb(terri ~ year + (1|fyear)+ (1|id), family="nbinom", data=data)
summary(M1)
