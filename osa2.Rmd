...
M4=glmmTMB(terri ~ SSS + agri5 +  X*Y + year*shan + year*open  + (1|id), family=nbinom2, data=data)
summary(M4)

M5=glmmTMB(terri ~ SSS + agri5 +  X*Y + year*temp + year*prec + year*ndvi + year*shan + year*open  + (1|id), family=nbinom2, data=data)
summary(M5)
```
