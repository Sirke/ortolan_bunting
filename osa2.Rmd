...
M0=gamm4(terri ~ year + offset(log(area)), random= ~(1 + year|id), family=nbinom2, data=dataS) #gamm4-funktiolla random-argumentti on vähän erilainen, offset toimii myös erilailla
